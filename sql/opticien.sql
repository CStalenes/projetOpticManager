...
begin
    ...
    insert into Technicien values(p_idPersonne, p_nom, p_prenom, p_adresse, p_email, p_typerole, p_diplome);
end $
delimiter ;
...
insert into Technicien values(1,"OPPS", "John","12 rue de la Roserais", "op@gmail.com","admin",  "licence");
insert into Technicien values(2,"WIND", "Stella","10 rue Montrouge", "ws@gmail.com","admin", "bts");
insert into Technicien values(3,"YOSHIDA", "Sabrina","53 RUE Ferrerol", "ys@gmail.com","user", "master");
insert into Technicien values(4,"JAGGERJACK", "Bruno","63 rue des Tuileries" , "jb@gmail.com","user", "bac pro");
insert into Technicien values(5,"KONTE", "Anis","10 rue Mo", "ka@gmail.com","user", "licence");
insert into Technicien values(6,"JOJO", "Giorno", "92 Rue de Villmonble", "jg@yahoo.fr","admin","master");
insert into Technicien values(7,"BOLT", "Chochise", "70 Rue de Lyon", "bc@yahoo.fr","user","licence");
...
begin
    ...
    insert into Client values(p_idPersonne, p_nom, p_prenom, p_adresse, p_email, p_typerole, p_age, p_telephone);
end $
delimiter ;
...
insert into Client values(1,'DEMBELE', 'Fabrice', '80 Faubourg Saint Honore', 'df@yahoo.fr','user', 24, '01059839');
insert into Client values(2,'ZINDAYA', 'Claire', '80 Place de la Madelaine', 'zc@yahoo.fr', 'user',20, '01397347');
insert into Client values(3,'NEWGATE', 'Edouard', '3 Rue Edouard Branly', 'ne@yahoo.fr', 'user', 35,'07506283');
insert into Client values(4,'MARIA', 'Bethany', '43 Place de Miremont', 'mb@hotmail.com', 'user', 29,'01588846');
insert into Client values(5,'BOEDER', 'Alex', '24 Avenue Voltaire', 'ba@hotmail.com', 'user', 23,'07222236');
insert into Client values(6,'HERCULES', 'Zack', '65 Rue du Palais', 'hz@hotmail.com', 'user', 50,'07498520');
insert into Client values(7,'HERO', 'Zacky', '68 Rue du Palais', 'zh@hotmail.com', 'user', 23,'07498622');
...
/*
create view personneTech as (
    select t.idPersonne, t.nom as nomTech, t.prenom as prenomTech ,t.adresse as adresseTech,t.email as emailTech, t.typerole as roleTech,t.diplome 
    from Personne p, Technicien t
...
/*/create view personneClient as (
    select c.idPersonne, c.nom as nomCli, c.prenom as prenomCli, c.adresse adresseCli, c.email as emailCli, c.typerole as roleCli, c.age, c.telephone 
...
create view rdvClientMagasin as (
    select r.idRDV, r.motif, r.dateRDV, r.heuredebut, r.heurefin, p.nom as nomCli, p.prenom as prenomCli, mg.nom as nomMagasin, mg.telephone as telMagasin
    from Personne p, RDV r, Magasin mg
    where r.idPersonne = c.idPersonne
    and c.idPersonne = p.idPersonne 
    and r.idMagasin = mg.idMagasin
);
